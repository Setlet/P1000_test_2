...
btnClick('EKÜ Z Detay Raporu')

while (Mobile.verifyElementNotExist(findTestObject('Object Repository/dynamic-button-object-image', [('icon-id') : 'levelIcon']) , 1, FailureHandling.OPTIONAL))
{
	Mobile.delay(1)
}	
Mobile.delay(1)
