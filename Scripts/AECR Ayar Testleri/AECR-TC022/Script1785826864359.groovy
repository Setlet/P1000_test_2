...
Mobile.scrollToText('Dil Ayarları')
btnClick('Dil Ayarları')
btnClick('English')
Mobile.verifyElementExist(findTestObject('Object Repository/dynamic-label-object',[('text'):'Language Settings']),5)
btnClick('Türkçe')
