...
btnClick('Kuyumcu Ayarları')
Mobile.tap(findTestObject('Object Repository/dynamic-button-object',[('text'):'Kuyumcu Satışı']), 2, FailureHandling.STOP_ON_FAILURE)
Mobile.pressBack()
...
Mobile.delay(2)
Mobile.tap(findTestObject('Object Repository/dynamic-button-object-image',[('text_id'):'jewelerySaleSwitch']), 2, FailureHandling.STOP_ON_FAILURE)
