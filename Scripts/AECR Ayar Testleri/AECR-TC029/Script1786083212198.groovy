...
btnClick('Uçuş Modu')
 ...
 String adbCommand = '/Users/erciyesanadoluholding/Library/Android/sdk/platform-tools/adb adb shell settings get global airplane_mode_on' 
 Process process = adbCommand.execute()
 process.waitFor()
if (adbCommand.execute() == "1") {

	KeywordUtil.markPassed("Uçuş Modunda")
} 
