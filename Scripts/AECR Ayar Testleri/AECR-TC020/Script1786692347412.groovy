...
btnClick('İndirim / Artırım Ayarları')
btnClick('Artırım')
imageBtnClick('ETSurchargePer')

Mobile.setText(findTestObject('Object Repository/dynamic-textbox-object', ,[('txtbox-id'):'ETSurchargePer']), artırım, 0)
btnClick('Kaydet')