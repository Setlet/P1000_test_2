...
Mobile.tap(findTestObject('Object Repository/POSTech/dynamic-button-object',[('button-name') : 'Yönetici Şifresi Değiştir']) , 2)


Mobile.tap(findTestObject('Object Repository/POSTech/Eski Ynetici ifresi'), 2)
Mobile.sendKeys('0000')
Mobile.delay(2)
Mobile.tap(findTestObject('Object Repository/POSTech/Yeni Ynetici ifresi'), 2)
Mobile.sendKeys('2560')
Mobile.delay(2)
Mobile.tap(findTestObject('Object Repository/POSTech/Tekrar Yeni Ynetici ifresi'), 2)
Mobile.sendKeys('2560')
Mobile.delay(2)
Mobile.sendKeys('\n')
Mobile.delay(2)
