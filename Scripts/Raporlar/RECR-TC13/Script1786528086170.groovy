...
Mobile.setText(findTestObject('Object Repository/dynamic-button-object-image', [('icon-id'):'ETStartPluNo']), ay, 2)
Mobile.delay(2)
Mobile.tap( findTestObject('Object Repository/dynamic-button-object-image' , [('icon-id'):'ETEndPluNo'])  , 2)
Mobile.setText(findTestObject('Object Repository/dynamic-button-object-image', [('icon-id'):'ETEndPluNo']), gun, 2)