...
btnClick('Parametre Yükleme')

Mobile.delay(1)
btnClick('Parametre Yükleme')
  
if (Mobile.verifyElementExist(findTestObject('Object Repository/dynamic-label-object', [('text') : 'Başarılı']), 5, FailureHandling.OPTIONAL)) {
	Mobile.waitForElementPresent(findTestObject('Object Repository/dynamic-button-object' , [('text') : 'Tamam']),  5)
	btnClick('Tamam')
}
Mobile.delay(1)
