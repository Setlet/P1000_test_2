...
btnClick('Balık')
btnClick('Ödeme')
btnClick('Parçalı Ödeme')
imageBtnClick('equalSelectionToggle')
imageBtnClick('three')
imageBtnClick('buttonDivideEqual')
labelDetectStartsWith('1) ')
imageBtnClick('buttonMakePaymentSelected')
btnClick('Nakit')
btnClick('Parçalı Ödeme')
labelDetectStartsWith('2) ')
imageBtnClick('buttonMakePaymentSelected')
