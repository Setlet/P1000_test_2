...
labelDetect('Avans')
txtboxClick('Vergi Kimlik No')
Mobile.setText(findTestObject('Object Repository/Sale/Document Types/Advance Payment/advance_payment_textbox_tax_id_number'), 55555555555, 5)
txtboxClick('TC Kimlik No')
11.times{
	imageBtnClick('one')
}
txtboxClick('Ön Tahsilat Tutarı')
imageBtnClick('one')
4.times{
	imageBtnClick('zero')
}
